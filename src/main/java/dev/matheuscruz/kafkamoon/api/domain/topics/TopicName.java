...
public final class TopicName {
   ...
   public boolean equals(Object obj) {
      ...
      return Objects.equals(this.messageType, that.messageType) && Objects.equals(this.dataset, that.dataset)
   ...
   public String toString() {
      return "TopicName[" + "messageType=" + messageType + ", " + "dataset=" + dataset + ", " + "dataName=" + dataName
            + ']';
   }
